export const galleryImages = [
    ...
    {
        id: 26,
        src: '/assets/img/gallery/KaiShiPose27.png',
        title: 'ELEGANT STILLNESS',
        theme: 'gothic',
        description: 'Dressed with refined details, Kai Shi sits in silence, graceful yet untouchable.',
        tags: ['elegant', 'gothic', 'jewelry', 'soft light'],
        resolution: '1920×1080',
        size: '4.7 MB',
        format: 'PNG',
        views: 125,
    ...
    {
        id: 27,
        src: '/assets/img/gallery/KaiShiPose28.png',
        title: 'MIDNIGHT RIFF',
        theme: 'urban',
        description: 'With her bass in hand, Kai Shi lets music speak where words fall short.',
        tags: ['music', 'bass guitar', 'night', 'street vibe'],
        resolution: '1920×1080',
        size: '4.7 MB',
        format: 'PNG',
        views: 155,
    ...
    {
        id: 28,
        src: '/assets/img/gallery/KaiShiPose29.png',
        title: 'RESTLESS GAZE',
        theme: 'urban',
        description: 'Leaning into the quiet, Kai Shi looks tired yet thoughtful, lost in her own head.',
        tags: ['introspective', 'dark mood', 'close-up', 'night'],
        resolution: '1920×1080',
        size: '4.7 MB',
        format: 'PNG',
        views: 125,
    ...
    {
        id: 29,
        src: '/assets/img/gallery/KaiShiPose30.png',
        title: 'PLAYFUL SIGNAL',
        theme: 'cute',
        description: 'Bright colors and playful energy show a lighter side of Kai Shi rarely seen.',
        tags: ['cute', 'headphones', 'playful', 'anime style'],
        resolution: '1920×1080',
        size: '4.7 MB',
        format: 'PNG',
        views: 125,
    ...
    {
        id: 30,
        src: '/assets/img/gallery/KaiShiPose31.png',
        title: 'WARM SPARK',
        theme: 'cute',
        description: 'Wrapped in warmth, Kai Shi smiles softly, enjoying a simple and comforting moment.',
        tags: ['cozy', 'soft colors', 'warm mood', 'casual'],
        resolution: '1920×1080',
        size: '4.7 MB',
        format: 'PNG',
        views: 125,
    ...
    {
        id: 31,
        src: '/assets/img/gallery/KaiShiPose32.png',
        title: 'NEW YEAR LIGHTS',
        theme: 'event',
        description: 'As fireworks fill the sky, Kai Shi watches with quiet wonder, holding onto the moment.',
        tags: ['fireworks', 'night', 'cinematic', 'winter'],
        resolution: '1920×1080',
        size: '4.7 MB',
        format: 'PNG',
        views: 125,
    ...
    {
        id: 32,
        src: '/assets/img/gallery/KaiShiPose33.png',
        title: 'SHADOW FORM',
        theme: 'portrait',
        description: 'Hidden in shadow, Kai Shi moves with a quiet presence that feels both distant and dangerous.',
        tags: ['gothic', 'dark outfit', 'mysterious', 'night'],
        resolution: '1920×1080',
        size: '4.7 MB',
        format: 'PNG',
        views: 155,
    ...
    {
        id: 33,
        src: '/assets/img/gallery/KaiShiPose34.png',
        title: 'URBAN STATIC',
        theme: 'urban',
        description: 'Against the cold city backdrop, Kai Shi stands firm, grounded in her own world.',
        tags: ['urban', 'streetwear', 'jacket', 'night city'],
        resolution: '1920×1080',
        size: '4.7 MB',
        format: 'PNG',
        views: 155,
    ...
    {
        id: 34,
        src: '/assets/img/gallery/KaiShiPose35.png',
        title: 'URBAN COMPANION',
        theme: 'urban cozy',
        description: 'Kai Shi stands under city lights with her loyal companion, finding warmth in a cold urban night.',
        tags: ['urban', 'night city', 'companion', 'soft light', 'streetwear'],
        resolution: '1920×1080',
        size: '4.7 MB',
        format: 'PNG',
        views: 200,
    ...
    {
        id: 35,
        src: '/assets/img/gallery/KaiShiPose36.png',
        title: 'REDLINE SIGNAL',
        theme: 'cyberpunk rebel',
        description: 'With wires and red accents around her, Kai Shi moves fast through chaos and raw energy.',
        tags: ['cyberpunk', 'rebel', 'red accents', 'techwear'],
        resolution: '1920×1080',
        size: '4.7 MB',
        format: 'PNG',
        views: 300,
    ...
    {
        id: 37,
        src: '/assets/img/gallery/KaiShiPose38.png',
        title: 'SKULL STRIKE',
        theme: 'urban combat',
        description: 'Weapon raised and eyes locked forward, Kai Shi shows no hesitation when it’s time to act.',
        tags: ['combat', 'urban fighter', 'weapon', 'aggressive'],
        resolution: '1920×1080',
        size: '4.7 MB',
        format: 'PNG',
        views: 500,
    ...
    {
        id: 38,
        src: '/assets/img/gallery/KaiShiPose39.png',
        title: 'CHAINED WILL',
        theme: 'dark rebellion',
        description: 'Even bound by chains, Kai Shi stares back with defiance, unbroken and unafraid.',
        tags: ['chains', 'rebellion', 'dark mood', 'defiance'],
        resolution: '1920×1080',
        size: '4.7 MB',
        format: 'PNG',
        views: 600,
    ...
    {
        id: 39,
        src: '/assets/img/gallery/KaiShiPose40.png',
        title: 'NEON FOCUS',
        theme: 'cyberpunk',
        description: 'Headphones on and mind locked in, Kai Shi disappears into code and glowing screens.',
        tags: ['cyberpunk', 'hacker', 'headphones', 'night work'],
        resolution: '1920×1080',
        size: '4.7 MB',
        format: 'PNG',
        views: 600,
    ...
    {
        id: 40,
        src: '/assets/img/gallery/KaiShiPose41.png',
        title: 'BLUE HOUR SILENCE',
        theme: 'urban night',
        description: 'In the quiet blue glow of the city, Kai Shi takes a moment to breathe and observe.',
        tags: ['night', 'city lights', 'calm', 'introspective'],
        resolution: '1920×1080',
        size: '4.7 MB',
        format: 'PNG',
        views: 600,
    ...
    {
        id: 41,
        src: '/assets/img/gallery/KaiShiPose42.png',
        title: 'CRIMSON EDGE',
        theme: 'dark punk',
        description: 'Leaning forward with a sharp smile, Kai Shi carries danger in both attitude and presence.',
        tags: ['punk', 'dark style', 'attitude', 'close-up'],
        resolution: '1920×1080',
        size: '4.7 MB',
        format: 'PNG',
        views: 600,
    ...
    {
        id: 42,
        src: '/assets/img/gallery/KaiShiPose43.png',
        title: 'VENOM SMILE',
        theme: 'gothic dark',
        description: 'With a teasing grin and cold eyes, Kai Shi blurs the line between charm and threat.',
        tags: ['gothic', 'dark portrait', 'seductive', 'dangerous'],
        resolution: '1920×1080',
        size: '4.7 MB',
        format: 'PNG',
        views: 600,
...
export const getImageById = (id) => {
    return galleryImages.find(image => image.id === parseInt(id));
};

// Helper function to get images by theme
export const getImagesByTheme = (theme) => {
    if (theme === 'all') return galleryImages;
    return galleryImages.filter(image => image.theme === theme);
};
...
export const getUniqueThemes = () => {
    const themes = galleryImages.map(image => image.theme);
...
export const getGalleryStats = () => {
    ...
    // Calculate total size (mock - in real app this would come from API)
    const totalSize = galleryImages.reduce((sum, image) => {
        const size = parseFloat(image.size) || 0;
        return sum + size;
    }, 0);
    
    // Calculate total views and likes
    const totalViews = galleryImages.reduce((sum, image) => sum + image.views, 0);
    const totalLikes = galleryImages.reduce((sum, image) => sum + image.likes, 0);
    
    // Count images per theme
    const themeCounts = {};
    galleryImages.forEach(image => {
        themeCounts[image.theme] = (themeCounts[image.theme] || 0) + 1;
    });
    ...
    return {
        ...
        averageResolution: '1920×1080',
        mostPopularImage: galleryImages.reduce((max, image) => 
            image.views > max.views ? image : max
        ),
        newestImage: galleryImages.reduce((newest, image) => 
            new Date(image.date) > new Date(newest.date) ? image : newest
        )
    };
};

// Function to add new image (for future use)
export const addImage = (imageData) => {
    ...
    galleryImages.unshift(newImage); // Add to beginning
    return newImage;
};
